const config = {
	ownerID: ['834098038964092938'],
	token: 'ODM0MDk4MDM4OTY0MDkyOTM4.YH78VQ.3fEhov0zDFDxhi3eYRdESxWuzHY',
	botClient: 'DymSG7GJLNpAn7L6zNaZQ1ARt-ddqVju',
	// replace BOTID with the bot's ID
	inviteLink: 'https://discord.com/api/oauth2/authorize?client_id=834098038964092938&permissions=0&scope=bot',
